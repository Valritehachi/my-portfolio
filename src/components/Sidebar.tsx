  ...
  return (
    <>
      ...
      <aside
        ...
        style={{ backgroundColor: "hsla(268, 65%, 12%, 0.98)", padding: "5% 3%" }}
      >
        ...
        <div className="flex justify-center mb-4">
          <div
            ...
            style={{ backgroundColor: "#1a0535", color: "#a78bfa", border: "2px solid #a78bfa" }}
          >
            VH
          </div>
        </div>
        ...
        <div className="text-center mb-4">
          ...
          <p className="text-xs font-semibold mt-1 m-0" style={{ color: "#a78bfa" }}>
