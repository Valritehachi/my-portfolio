  ...
  return (
    <>
      ...
      <aside
        ...
        style={{ backgroundColor: "hsla(210, 60%, 16%, 0.97)", padding: "5% 2%" }}
      >
        ...
        <div className="flex justify-center mb-4">
          <div
            ...
            style={{ backgroundColor: "#0a1f33", color: "#7eb3de", border: "2px solid #7eb3de" }}
          >
            VH
          </div>
        </div>
        ...
        <div className="text-center mb-4">
          ...
          <p className="text-xs font-semibold mt-1 m-0" style={{ color: "#7eb3de" }}>
            ...
            {links.map(({ href, label }) => (
              <li key={href} className="pb-4">
                <Link
                  ...
                  style={{ color: "#7eb3de", textDecoration: "none" }}
                >
                  {label}
                </Link>
              </li>
